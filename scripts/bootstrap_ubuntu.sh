...
sudo apt install -y pandoc lynx texlive texlive-xetex perl-tk arename krename
...
sudo apt install -y fonts-powerline fonts-firacode ttf-mscorefonts-installer command-not-found command-not-found-data pop-theme
